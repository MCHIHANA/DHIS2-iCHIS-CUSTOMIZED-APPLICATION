...
2. Grant **Nearby devices** â†’ Allow
3. Grant **Location** â†’ Allow
4. Settings â†’ Location â†’ Turn ON

**Android 11 and below:**
1. Settings â†’ Apps â†’ DHIS2 â†’ Permissions
2. Grant **Location** â†’ Allow
3. Settings â†’ Location â†’ Turn ON
...
4. Should progress through: Scanning â†’ Found devices â†’ Connecting â†’ Connected
...
**Check Bluetooth:**
```
Notification panel â†’ Bluetooth: ON
Settings â†’ Bluetooth â†’ FORA02: NOT PAIRED (should be unpaired)
```
...
BleManager: Target sensor detected: SPO2 (C0:26:DA:17:D5:7D) â€” connecting now
...
BLE_SPO2:  Valid reading: SpO2=95% Pulse=72 bpm â€” emitting to ViewModel
BleManager: Readings received from device: 2 values
BleManager:   â†’ SPO2 = 95
BleManager:   â†’ PULSE = 72
...
**Fix:** Settings â†’ Apps â†’ DHIS2 â†’ Permissions â†’ Location â†’ Allow
