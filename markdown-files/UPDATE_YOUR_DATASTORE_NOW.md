...
Open DHIS2 web interface â†’ Login â†’ Press F12 (browser console) â†’ Run:
...
1. **Android device**: Settings â†’ Apps â†’ DHIS2 â†’ Clear Data
2. **Open app** â†’ Login â†’ Settings â†’ Sync metadata
3. **Test BP sensor** â†’ All 3 values should save correctly

##  IMPORTANT: Verify UIDs First!

Before updating DataStore, **verify your actual UIDs** in DHIS2:

1. Go to **Maintenance** â†’ **Data Elements**
2. Search for "Diastolic Pressure" â†’ Copy UID
3. Search for "Pulse Rate" â†’ Copy UID
...
In DHIS2 Maintenance â†’ Data Elements:
