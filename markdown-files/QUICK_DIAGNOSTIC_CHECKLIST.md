...
### 1. Permissions 
- [ ] Open Settings â†’ Apps â†’ DHIS2 â†’ Permissions
- [ ] **Nearby devices** permission: GRANTED
- [ ] **Location** permission: GRANTED
- [ ] Location services: ON (Settings â†’ Location)
...
1. **In DHIS2 web interface:**
   - Go to Maintenance â†’ Data Element
...
9. **Tap the â†“ icon** (enable notifications)
