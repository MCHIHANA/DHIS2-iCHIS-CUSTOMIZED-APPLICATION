...
5. If no permission dialog appears, go to Settings â†’ Apps â†’ DHIS2 â†’ Permissions and grant manually

### Step 3: Test Connection
1. Ensure FORA02 is powered on
2. Tap "Connect Sensor" button
3. Watch the status messages
4. Should see: "Scanning..." â†’ "Found 1 device(s)..." â†’ "Connecting..." â†’ "Connected..."
...
4. Go to Settings â†’ Location â†’ Turn ON
5. Try again
