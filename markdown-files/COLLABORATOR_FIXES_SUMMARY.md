...
if (allAreBpKeys) {
    Log.d("SENSOR_DATA", "BP sensor detected â€” using hardcoded field mapping")
    readings.forEach { (key, value) ->
        val fieldUid = bpFieldMap[key.uppercase()]!!
        Log.d("SENSOR_DATA", "Mapping $key â†’ $fieldUid")
...
SENSOR_DATA: BP sensor detected â€” using hardcoded field mapping
