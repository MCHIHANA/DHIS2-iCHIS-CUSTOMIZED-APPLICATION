...
3. **Memory Configuration** (Commit: 590b31b)
   - Increased Gradle JVM: 4GB â†’ 6GB
   - Increased Kotlin daemon: 2GB â†’ 4GB
...
1. **Restart IDE** - File â†’ Invalidate Caches â†’ Invalidate and Restart
2. **Sync Gradle** - File â†’ Sync Project with Gradle Files  
3. **Build Project** - Build â†’ Rebuild Project
