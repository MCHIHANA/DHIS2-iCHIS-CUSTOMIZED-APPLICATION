...
private val dataElementMapping = mapOf(
    ...
    "YOUR_TEMP_UID" to VitalSignType.TEMPERATURE,  // â† Update this
    "YOUR_GLUCOSE_UID" to VitalSignType.BLOOD_GLUCOSE,  // â† Update this
    // ... add more
)
```
...
- [ ] Login as unauthorized user â†’ Access denied screen
...
### Offline Testing
- [ ] Disable network â†’ Dashboard still works
- [ ] Enable network â†’ Refresh loads new data
