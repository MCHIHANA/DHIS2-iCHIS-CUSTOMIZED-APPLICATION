...
**Android 12+ (API 31+):**
1. Go to Settings → Apps → DHIS2 App → Permissions
...
4. Clear Bluetooth cache: Settings → Apps → Bluetooth → Storage → Clear Cache
...
### Clear App Data
```
Settings → Apps → DHIS2 App → Storage → Clear Data
```
